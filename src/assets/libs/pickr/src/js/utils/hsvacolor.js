...
export function HSVaColor(h = 0, s = 0, v = 0, a = 1) {
  ...
  const that = {
    ...
    toHSVA() {
      ...
      hsva.push(that.a)
      hsva.toString = () =>
        `hsva(${rhsva[0]}, ${rhsva[1]}%, ${rhsva[2]}%, ${that.a.toFixed(1)})`
      return hsva
    },
    ...
    toHSLA() {
      ...
      hsla.push(that.a)
      hsla.toString = () =>
        `hsla(${rhsla[0]}, ${rhsla[1]}%, ${rhsla[2]}%, ${that.a.toFixed(1)})`
      return hsla
    },
    ...
    toRGBA() {
      ...
      rgba.push(that.a)
      rgba.toString = () =>
        `rgba(${rrgba[0]}, ${rrgba[1]}, ${rrgba[2]}, ${that.a.toFixed(1)})`
      return rgba
    },
    ...
    toCMYK() {
      ...
      cmyk.toString = () =>
        `cmyk(${rcmyk[0]}%, ${rcmyk[1]}%, ${rcmyk[2]}%, ${rcmyk[3]}%)`
      return cmyk
    },
